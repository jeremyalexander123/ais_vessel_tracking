...
aus_bound = gpd.read_file('/Volumes/ElementsSE/Reef Authority/shp_boundaries/Boundary_Australia/Australia_Boundary.shp')
aus_bound = aus_bound.to_crs("EPSG:4326")

# gbr boundary
gbr_boundary = gpd.read_file('/Volumes/ElementsSE/Reef Authority/shp_boundaries/Boundary_GBRMPA/Great_Barrier_Reef_Marine_Park_Boundary.shp')
gbr_boundary = gbr_boundary.to_crs("EPSG:4326")

# emc boundary
emc_bound = gpd.read_file('/Volumes/ElementsSE/Reef Authority/shp_boundaries/emc_no_mgmt.shp')
emc_bound = emc_bound.to_crs("EPSG:4326")

# tumra boundary
tumra = gpd.read_file('/Volumes/ElementsSE/Reef Authority/shp_boundaries/Boundary_TUMRA/Traditional_Use_of_Marine_Resources_Agreement_areas.shp')
tumra = tumra.to_crs("EPSG:4326")

# shipping lanes
shipping_boundary = gpd.read_file('/Volumes/ElementsSE/Reef Authority/shp_boundaries/shipping_boundary/Designated_Shipping_Areas_of_the_GBRMP.shp')
shipping_boundary = shipping_boundary.to_crs("EPSG:4326")

# shipping lanes
gbr_features = gpd.read_file('/Volumes/ElementsSE/Reef Authority/shp_boundaries/gbr_features_no_mainland.shp')
gbr_features = gbr_features.to_crs("EPSG:4326")

# gbr zoning
gbr_zoning = gpd.read_file('/Volumes/ElementsSE/Reef Authority/shp_boundaries/Boundary_GBRMPA_Zoning/Great_Barrier_Reef_Marine_Park_Zoning.shp')
